...
function deleteItemFromCollectionByPosition($gameKey,$gameInstanceKey,$gameObjectKey,$collectionKey,$index,&$db,&$arrayResponse)
{
	$arrayResponse = array();
	//$gameInstance_ID = 0;
	$arrayDetails = array();
	$arrayDetails["action"] = "deleteItemFromCollectionByPosition";
